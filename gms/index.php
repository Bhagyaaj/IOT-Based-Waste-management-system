...
<head>
    <meta charset="utf-8">
    <title>IoT Based Waste Management System || Home Page</title>
...
{               ?>      
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">IoT Based Waste Management System </h2>
        </a>
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img1/feature.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">IoT Based Waste Management System</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Sustainability Oriented!</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">With Optimisation of Routes</p>
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">IoT Based Waste Management System </h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Collection of Wastes , Complaint Registration..</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Internet of things</p>
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">IoT Based Waste Management System </h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Waste Management Services</h1>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">IoT Based Waste Management System </a>, All Right Reserved.
                    </div>
